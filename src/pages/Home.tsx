...
export function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center py-10 px-1 lg:p-24 bg-main-red mt-16 lg:mt-20">
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 p-10 lg:p-20">
        <div className="flex flex-col gap-7">
          ...
          <h2 className="text-white font-primary lg:text-xl font-light lg:w-[70%]">
            Could you give a pet a forever home? Browse our pets looking for a
            new start.
          </h2>
